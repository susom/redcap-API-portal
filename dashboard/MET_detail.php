...
<div id="met_results">
	...
	<div id="met_bmi" class="met_desc">
		...
		<div class="moreinfo" id="what_is_bmi">
			...
			<h3>What is BMI?</h3>
			<p>BMI is a person's weight in kilograms (kg) divided by his or her height in meters squared. The National Institutes of Health (NIH) now defines normal weight, overweight, and obesity according to BMI rather than the traditional height/weight charts.</p>
		</div>
		<div class="bmi_b">
