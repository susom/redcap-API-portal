    ...
    if($this->surveycomplete){
      ...
      foreach($this->raw as $field){
        ...
        if(isset($MAT_video_key)){
          $section_html[] = '<div class="video_frame"><iframe id="kaltura_player" src="'.$MAT_videos[$MAT_video_key].'" width="532" height="379" allowfullscreen webkitallowfullscreen mozAllowFullScreen frameborder="0"></iframe></div>';
        }
