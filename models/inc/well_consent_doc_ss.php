...
<section class="lang sp">
	...
	<p>La Iniciativa de WELL Para Vida tiene como meta identificar factores que contribuyen al bienestar y la salud. La Iniciativa de WELL Para Vida ha sido creada por el Centro de Investigación de Prevención de Stanford en la escuela de medicina de Stanford.</p> 
	<p>Usted ha sido invitado(a) a ser parte del registro de WELL Para Vida, cual está recolectando información sobre la salud y el bienestar. Como participante de WELL Para Vida, usted será invitado(a) a participar en los futuros proyectos de WELL Para Vida. Nuestra meta es inscribir participantes de todas partes de los Estados Unidos.</p>
...
<section class="lang sp">
	...
	<p>El Registro de WELL Para Vida consiste de un número de encuestas computadorizadas. La primera encuesta tomará alrededor de 20-30 minutos y le pide sus detalles de contacto y sobre detalles demográficos básicos (ej. Edad, género, lenguaje), hábitos y estilo de vida, y su comunidad. Después, las encuestas incluirán preguntas similares sobre su estilo de vida, salud, y bienestar. También puede ser que le pediremos que provea una foto o grabación de video. Usted tiene el derecho de decidir a no contestar preguntas especificas.</p>
	<p>Intentaremos diferentes estrategias para convertir su experiencia con WELL Para Vida en una experiencia entretenida. Por ejemplo, algunas encuestas podrían ser como “juegos,” podríamos proveerle diferentes tipos de sugerencias, cambiar el orden en que contesta las encuestas o los mensajes que le enviamos, y proveerle contenido informacional.</p>
	<p>Le podríamos preguntar si está interesado(a) en ser entrevistado(a) sobre su experiencia como participante de WELL Para Vida. Si NO desea ser contactado(a) para ser entrevistado(a), por favor indíquelo en la primera encuesta.</p>
