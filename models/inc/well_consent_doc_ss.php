...
<section class="lang en">
	...
	<p>We anticipate the study will continue to 2099, and we welcome your involvement for as long as you can take part. The more surveys you complete, the more we will learn about wellbeing and health overtime.</p>
...
<section class="lang en">
	...
	5 Palo Alto Square, 4th Floor<br>
	Palo Alto, CA 94306
	</addr></p>
</section>
...
<section class="lang en">
	...
	<p>The WELL for Life Registry is an international registry created by the Stanford Prevention Research Center in the Stanford University School of Medicine. The WELL for Life Registry will provide an ongoing source of valuable information on factors related to health and wellness. Thousands of people from all over the world are anticipated to take part in the WELL for Life Registry.</p>
	...
	<h3>Who May Receive or Use the Information?</h3>
	<p>The parties listed in the preceding paragraph may disclose your health information to the following persons and organizations for their use in connection with this research study:</p>
	<ul>
	<li>The Office for Human Research Protections in the U.S. Department of Health and Human Services</li>
	<li>Data safety monitoring board, approved collaborators within Stanford University and from other institutions, outside data analysts</li>
	</ul>

	<p>Your information may be re-disclosed by the recipients described above, if they are not required by law to protect the privacy of the information.</p>

	<h3>When will my authorization expire?</h3>
...
<section class="lang sp">
	...
	<p>Le podríamos pedir su permiso para incluir su nombre, detalles de contacto, y respuestas de la primera encuesta que complete en el Registro de Stanford. Esto es un registro de individuos que están de acuerdo a ser contactados en el futuro para aprender más sobre estudios investigativos en Stanford. Esto no le obliga a participar en estos estudios. Si NO desea ser contactado(a), por favor indíquelo en la primera encuesta.</p>
</section>

<section class="lang sp">
	<h2>DURACION DE SU INVOLUCRAMIENTO CON EL ESTUDIO</h2>
	<p>Anticipamos que este estudio continuará hasta 2099 y usted puede involucrarse con este proyecto por cuanto tiempo desee. Mientras más encuestas complete, más aprenderemos sobre su bienestar y salud a través del tiempo.</p>

	<h2>PARTICIPACION VOLUNTARIA</h2>
	<p>Su participación es completamente voluntaria. Su decisión de no participar no tendrá ningún impacto en usted o su cuido médico. Usted puede decidir a participar ahora, pero luego retirar su consentimiento y parar de ser parte del estudio a ningún costo a sus beneficios o salud médica.</p>
</section>

<section class="lang sp">
	<h2>POSIBLES BENEFICIOS</h2>       
	<p>La meta del Programa de Investigación de Vivir Bien es aprender cómo promover vivir bien. No podemos garantizar o prometer que recibirá algún beneficio de este estudio. Todos los participantes recibirán información sobre vivir bien y también recibirán información continua sobre el estudio investigativo. Al participar, usted también va a contribuir a la salud y el bienestar de su comunidad.</p>

	<h2>RIESGOS POSIBLES</h2>
	<p>Los riesgos asociados con este estudio son mínimos y no esperamos ningunos efectos negativos relacionados a su participación. Nosotros seguimos las regulaciones y protocolo federales, estatales, y de la Universidad de Stanford para proteger su información. Si algunas preguntas de la encuesta le hacen sentirse incómodo(a), usted puede elegir saltar esas preguntas. Mientras la pérdida de confidencialidad es un riesgo, nosotros nos esforzamos para proteger su información.</p>
</section>

<section class="lang sp"> 
	<h2>CONSIDERACIONES FINANCIERAS</h2>
	<h3>Payment and Costs</h3>
	<p>No será pagado por participar en este estudio. Sin embargo, puede ser que le proveeremos objetos con el logo del programa, tal como bolígrafos, camisas, cartapacios, etc. No hay ningún costo para participar en este estudio, sólo el tiempo que le tome completar las encuestas.</p>
</section>

<section class="lang sp">
	<h2>DERECHOS DEL PARTICIPANTE</h2>
	<p>Si ha leído este formulario y ha decidido participar en este proyecto, por favor entienda que su participación es voluntaria y usted tiene el derecho de darse de baja o descontinuar su participación a cualquier momento sin penalidad o pérdida de beneficios. La alternativa es no participar. Los resultados de este estudio pueden ser presentados en reuniones científicas o profesionales o publicados en revistas científicas. No obstante, su identidad no será revelada. Usted tiene el derecho a no contestar preguntas específicas.</p> 
</section>
...
<section class="lang sp">
	<h1>Autorización Para Usar Su Información de Salud Para Propósitos de Investigación</h1>
	<p>La información sobre su salud es personal y privada, y no puede ser utilizada en esta investigación sin su autorización. Seleccionar el botón que diga “Estoy de acuerdo a participar en este estudio” proveerá su autorización. La información proveída aquí le informará sobre cómo su información de salud será utilizada o revelada en este estudio. Su información solamente será utilizada en acorde con esta autorización y el consentimiento informado y como requerido o permitido por la ley. Por favor lea cuidadosamente antes de conceder a participar.</p>

	<h3>¿Cual es el propósito de esta investigación y cómo utilizarán mi información de salud?</h3>
	<p>El Registro de Vivir Bien es un registro internacional creado por el Centro de Investigación de Prevención de Stanford en la escuela de medicina de Stanford. El Registro de Vivir Bien será un recurso de información valiosa sobre factores relacionados a la salud y el bienestar. Miles de personas de todas partes del mundo serán parte del Registro de Vivir Bien.</p>

	<h3>¿Tengo que proveer mi autorización?</h3>
	...
	<ol>
	<li>Información de contacto (por ejemplo, nombre, dirección, número de teléfono, correo electrónico, información de contacto de amistades/familiares, URLs, dirección de IP.</li>
	<li>Data socio-económica (por ejemplo, edad, género, lugar de nacimiento, etnicidad, lenguaje, estatus matrimonial, número de hijos, número de personas en el hogar, educación, ingreso, empleo)</li> 
	<li>Información de salud (salud reportada, número de medicaciones, altura y peso, historial de salud)</li>
	<li>Comportamiento de salud (relacionado a actividad física, dormir, uso de tabaco y alcohol, dieta)</li>
	<li>Sus percepciones (por ejemplo, de su bienestar y emociones y su ambiente social y comunitario)</li>
	<li>Identificadores biométricos, incluyendo muestras de huellas dactilares, retina y voz</li>
	<li>Imágenes fotográficas de su cara e imágenes comparables</li>
	</ol>
	...
	<h3>¿Quién puede recibir o utilizar esta información?</h3>
	<p>Los partidos listados en el párrafo antecedente pueden revelar su información de salud a las siguientes personas y organizaciones para su uso en conexión con este estudio investigativo:</p>
	<ul>
	<li>La Oficina de Protecciones de Investigaciones Humanas en el Departamento de Salud y Servicios Humanos de Estados Unidos</li>
	<li>Junta para la seguridad y el monitoreo de data, colaboradores en otras instituciones, analistas de data externos, el Instituto Nacional de Salud</li>
	</ul>

	<p>Su información puede ser revelada por los recipientes descritos previamente, si no están requeridos por ley a proteger la privacidad de la información.</p>

	<h3>¿Cuando expirará mi autorización?</h3>
	<p>Su autorización para el uso o la revelación de su información de salud terminará en 12/31/2099 o cuando termine el proyecto, cualquiera venga primero.</p>

	<p>Por favor imprima una copia de esta página para sus records</p>
	<p>Si desea ser parte del estudio, por favor seleccione el botón que diga “Estoy de acuerdo a participar.” Entonces será dirigido a completar la encuesta de WELL.</p>
</section>
...
<section class="lang tw">
	...
	<p>我們誠意邀請您在此註冊『WELL人生』項目。該項目是收集關於大眾身心健康的信息。作為參與者，您將有機會被邀請加入其它『WELL人生』的相關活動。我們現階段的目標是招募10,000名居住在舊金山灣區的民眾。隨著項目的擴大，我們希望在不久的將來也可以招募來自美國各地的參與者。
</p>
...
<section class="lang tw">
	<h2>活動介紹</h2> 
	<p>『WELL人生』包括多個線上問卷調查。第一次問卷調查大約需要20-30分鐘，包括詢問您的聯繫方式和您的其他基本信息（例如年齡，性別，語言），生活和行為習慣（例如飲食，身體活動，煙草使用）和您所居的社區特徵。之後的調查將更進一步的訊問關於您生活方式習慣，身體健康和身體素質的相關問題。您還可能被要求提供照片，聲音或視頻記錄作為健康的衡量標準。您有權拒絕回答調查中的任何問題。</p>
	...
	<p>您可能會被問及是否同意將您首次參與線上問卷調查時所提供的姓名，聯繫方式等信息提供給Stanford研究註冊名單， 以便之後了解或加入在Stanford進行的其他研究。您沒有義務參加這些研究。如果您不希望參與，請在第一次問卷調查中告知。</p>
</section>

<section class="lang tw">
	<h2>項目期限</h2>
	<p>我們預計這項研究將持續到2099年，我們歡迎您的長期參與。您完成越多的調查，我們對大眾身心健康的理解就會越全面。</p>

	<h2>自願參加</h2>
	<p>您的參與完全是自願的。您決定不參加本項目將不會對您本人或您應享有的醫療護理服務產生任何負面影響。您可以現在參加，將來撤回您的知情同意書，並停止參加本研究，这些都不會影響到您所享有的福利或醫療護理服務。</p>
</section>

<section class="lang tw">
	<h2>參與益處</h2>       
	<p>『WELL人生』的重要目標是 學習如何讓人們的生活更美好。我們不能保證或承諾您將從本研究中獲得任何好處。所有參與者將收到有關健康生活的信息和研究相關的新增內容。通過參與這項研究，您還將為您的社區的健康和福祉做出貢獻。</p>

	<h2>可能的風險</h2>
	<p>與這項研究相關的風險是非常小的，我們認為參與該項目不會對您產生任何負面影響。我們遵循聯邦政府，州政府和學校的法律法規來保護您的個人跟熱資料。如果一些調查問題讓你感到不適，你可以選擇跳過它們。我們深知個人資料信息保密工作的重要性，所以我們將非常小心的保護您的資料。</p>
</section>

<section class="lang tw"> 
	<h2>財務方面</h2>
	<h3>參與費用</h3>
	<p>您不會因參與本研究而獲得任何報酬。但是您可能在研究期間獲得項目相關的紀念品，例如原子筆，文件夾，文化衫類似的衣物等。除了完成線上調查所需要佔用您的時間外，參與此研究不會向您收取任何費用。</p>
</section>

<section class="lang tw">
	<h2>參與人權益</h2>
	<p>如果您已詳細閱讀知情同意書並自願決定參與此項目， 我們歡迎您的加入。您的參與是完全自願的，並且您有權隨時撤銷知情同意並終止參與，您不會收到任何處罰，也不會失去您所享有的任何福利。本研究的結果可能會在業會議上或科學期刊上發表。但是您的身份及個人信息絕對不會被分享披露。您有權拒絕回答特定的問題。</p> 
</section>
...
<section class="lang tw">
	<h1>授權本研究將您的健康相關信息用於科學研究</h1>
	<p>因為您的健康將康信息屬於個人隱私，所以不能在未經允許的情況下用於科學研究。點擊“我同意加入本研究”將同意提供您健康信息的使用權。我們會在下文詳細說明您的健康信息將如何被使用於與該研究項目中。根據法律規定，您的個人信息將按照該知情同意書中所描述的僅限於本研究範圍內使用。 請您在同意加入本研究之前詳細閱讀知情同意書。</p>

	<h3>本研究的目的為何，以及我的健康資料如何在研究中應用？</h3>
	<p>『WELL人生』是由Stanford預防醫學研究中心創建的跨國身心健康资料库註冊表。『WELL人生』将見持續為參與者提供有利身心健康的寶貴信息 。預計全球範圍內有萬餘參與者將會加入 『WELL人生』項目。</p>

	<h3>我必須提供健康信息使用授權嗎？</h3>
	...
	<ol>
	<li>聯繫信息（例如姓名，地址，電話號碼，電子郵件地址，朋友/家人的聯繫方式，Web網址統一資源定位器（URL），Internet協議（IP）地址</li>
	<li>社會人口統計資料（例如年齡，性別，出生地點，種族，語言，婚姻狀況，育兒數，家庭人口數目，教育程度，收入，就業狀況）</li> 
	<li>健康相關信息（例如自報健康，處方藥物使用數量，自報的身高和體重，簡短健康疾病史）</li>
	<li>健康行為信息（例如與身體活動，睡眠，煙草、酒精使用，及飲食相關的信息）</li>
	<li>認知信息（例如，您的健康和情緒，以及您的社交和鄰里環境）</li>
	<li>生物信息識別，包括手指，視網膜和聲紋</li>
	<li>全臉相片圖片和任何類似圖片</li>
	</ol>
	...
	<h3>誰可能獲取或使用我的健康信息？</h3>
	<p>以上所列個人員及部門可能會講您的健康信息提供給以下研究人員和機構：</p>
	<ul>
	<li>美國衛生和人類服務部的人體研究保護辦公室</li>
	<li>數據安全監控委員會，Stanford大學校內及校外的其他合作機構，外部數據分析師。 </li>
	</ul>

	<p>在法律允許的前提下，您的健康數據有可能會被以上數據獲取方二次分享披露。</p>

	<h3>我的授權何時到期？</h3>
	<p>您的信息使用授權和/或分享披露您健康信息的許可將於2099年12月31日或研究計劃結束時（以較早者為準）到期。</p>

	<p>請打印此頁面作為您的個人記錄</p>
	<p>如果您希望參加本研究，請點擊“我同意”按鈕。然後，您將被引導完成第一次『WELL人生』問卷調查。</p>
</section>
...
<section class="lang cn">
	...
	<p>我们诚意邀请您在此注册『WELL人生』項目。该项目是收集关于大众身心健康的信息。作为参与者，您将有机会被邀请加入其它『WELL人生』的相关活动。我们现阶段的目标是招募10,000名居住在旧金山湾区的民众。随着项目的扩大，我们希望在不久的将来也可以招募来自美国各地的参与者。</p>
	<p>请按照您的个人意愿决定是否加入本研究。加入研究后，如果您中途决定结束参与本研究，请您通知John Ioannidis (650)725-5465或Sandra Winter (650)723-8513。</p> 
</section>

<section class="lang cn">
	<h2>活动介绍</h2> 
	<p>『WELL人生』包括多个线上问卷调查。第一次问卷调查大约需要20-30分钟，包括询问您的联系方式和您的其他基本信息（例如年龄，性别，语言），生活和行为习惯（例如饮食，身体活动，烟草使用）和您所居的社区特征。之后的调查将更进一步的讯问关于您生活方式习惯，身体健康和身体素质的相关问题。您还可能被要求提供照片，声音或视频记录作为健康的衡量标准。您有权拒绝回答调查中的任何问题。</p>
	...
	<p>您可能会被问及是否同意将您首次参与线上问卷调查时所提供的姓名，联系方式等信息提供给Stanford研究注册名单， 以便之后了解或加入在Stanford进行的其他研究。您没有义务参加这些研究。如果您不希望参与，请在第一次问卷调查中告知。</p>
</section>

<section class="lang cn">
	<h2>项目期限</h2>
	<p>我们预计这项研究将持续到2099年，我们欢迎您的长期参与。您完成越多的调查，我们对大众身心健康的理解就会越全面。</p>

	<h2>自愿参加</h2>
	<p>您的参与完全是自愿的。您决定不参加本项目将不会对您本人或您应享有的医疗护理服务产生任何负面影响。您可以现在参加，将来撤回您的知情同意书，并停止参加本研究，这些都不会影响到您所享有的福利或医疗护理服务。</p>
</section>

<section class="lang cn">
	<h2>参与益处</h2>       
	<p>『WELL人生』的重要目标是 学习如何让人们的生活更美好。我们不能保证或承诺您将从本研究中获得任何好处。所有参与者将收到有关健康生活的信息和研究相关的新增内容。通过参与这项研究，您还将为您的社区的健康和福祉做出贡献。</p>

	<h2>可能的风险</h2>
	<p>与这项研究相关的风险是非常小的，我们认为参与该项目不会对您产生任何负面影响。我们遵循联邦政府，州政府和学校的法律法规来保护您的个人资料。如果一些调查问题让你感到不适，你可以选择跳过它们。我们深知个人资料保密工作的重要性，所以我们将非常小心的保护您的资料。</p>
</section>

<section class="lang cn"> 
	<h2>财务方面</h2>
	<h3> 参与费用</h3>
	<p>您不会因参与本研究而获得任何报酬。但是您可能在研究期间获得项目相关的纪念品，例如原子笔，文件夹，文化衫类似的衣物等。除了完成线上调查所需要占用您的时间外，参与此研究不会向您收取任何费用。</p>
</section>

<section class="lang cn">
	<h2>参与人权益</h2>
	<p>如果您已详细阅读知情同意书并自愿决定参与此项目， 我们欢迎您的加入。您的参与是完全自愿的，并且您有权随时撤销知情同意并终止参与，您不会收到任何处罚，也不会失去您所享有的任何福利。本研究的结果可能会在会议上或科学期刊上发表。但是您的身份及个人信息绝对不会被分享。您有权拒绝回答特定的问题。</p> 
</section>
...
<section class="lang cn">
	<h1>授权本研究将您的健康相关信息用于科学研究</h1>
	<p>因为您的健康信息属于个人隐私，所以不能在未经允许的情况下用于科学研究。点击“我同意加入本研究”将同意提供您健康信息的使用权。我们会在下文详细说明您的健康信息将如何被使用于该研究项目中。根据法律规定，您的个人信息将按照该知情同意书中所描述的仅限于本研究范围内使用。请您在同意加入本研究之前详细阅读知情同意书。</p>

	<h3>本研究的目的为何，以及我的健康资料如何在研究中应用？</h3>
	<p>『WELL人生』是由Stanford预防医学研究中心创建的跨国身心健康资料库。 『WELL人生』将持续为参与者提供有利身心健康的宝贵信息 。预计全球范围内有万余参与者将会加入『WELL人生』项目。</p>

	<h3>我必须提供健康信息使用授权吗？</h3>
	...
	<ol>
	<li>联系信息（例如姓名，地址，电话号码，电子邮件地址，朋友/家人的联系方式，Web网址統一資源定位器（URL），Internet协议（IP）地址</li>
	<li>社会人口统计资料（例如年龄，性别，出生地点，种族，语言，婚姻状况，育儿数，家庭人口数目，教育程度，收入，就业状况）</li> 
	<li>健康相关信息（例如自报健康，处方药物使用数量，自报的身高和体重，简短健康疾病史）</li>
	<li>健康行为信息（例如与身体活动，睡眠，烟草、酒精使用，及饮食相关的信息）</li>
	<li>认知信息（例如，您的健康和情绪，以及您的社交和邻里环境）</li>
	<li>生物信息识别，包括手指，视网膜和声纹</li>
	<li>全脸相片图片和任何类似图片</li>
	</ol>
	...
	<h3>谁可能获取或使用我的健康信息？</h3>
	<p>以上所列个人员及部门可能会讲您的健康信息提供给以下研究人员和机构：</p>
	<ul>
	<li>美国卫生和人类服务部的人体研究保护办公室</li>
	<li>数据安全监控委员会，Stanford大学校内及校外的其他合作机构，外部数据分析师。 </li>
	</ul>

	<p>在法律允许的前提下，您的健康数据有可能会被以上数据获取方二次分享披露。</p>

	<h3>我的授权何时到期？</h3>
	<p>您的信息使用授权和/或分享您健康信息的许可将于2099年12月31日或研究计划结束时（以较早者为准）到期。</p>

	<p> 请打印此页面作为您的个人记录</p>
	<p>如果您希望参加本研究，请点击“我同意”按钮。然后，您将被引导完成第一次『WELL人生』问卷调查。</p>
</section>
